...
import imghhh from '../images/SAVIN.png';
...
export function Projects() {
    ...
    const projects = [
        {
            image: '', platform: 'Mobile Design', projectname: 'SAVIN APP',
        ...
        {
            image: '', platform: 'Mobile Design', projectname: 'WHATSAPP SCHEDULING MESSAGE FEATURE',
        ...
        {
            image: '', platform: 'Web Design', projectname: 'GERLACH REAL ESTATE',
        ...
        {
            image: '', platform: 'Web Design', projectname: 'CREATIVELY WEBSITE',
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: { xs: '40px', lg: "80px" }, px: { xs: '1.6rem', lg: '10rem' } }}>
                {
                    projects.map((x, i) => {
                        return (
                            <Box sx={{ width: '52.9rem', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                <Box component={'img'} scr={imghhh} height="400px" width={'100%'} />
                                <Typography sx={{
                                    fontFamily: "DM Sans",
